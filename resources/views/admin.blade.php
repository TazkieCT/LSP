                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-3">
                                ...
                                <div class="input-group mb-3">
                                        ...
                                        <input type="date" required class="form-control" value="" name="waktu" aria-label="Recipient's username" aria-describedby="button-addon2">
                            ...
                            <div class="col-3">
                                <form action="/admin" method="get">
                                <div class="input-group mb-3">
                                    <input type="text" required name="search"  value="" class="form-control" placeholder="Nomor aspirasi" aria-label="Recipient's username" aria-describedby="button-addon2">
                                ...
                                <table class="table border-top">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>
                                                <a class="btn btn-danger btn-sm" href="/admin/delete/{{ $as->id_aspirasi }}"><i class="bi bi-trash3"></i></a>
                                            </td> --}}
                                        </tr>
                                        @endforeach
                                    </tbody>
